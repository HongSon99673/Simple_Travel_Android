...
public class VicinityAllAsyncTask extends AsyncTask<Object, Void, ArrayList<Services>> {
    ...
    public VicinityAllAsyncTask(Context context, RecyclerView recyclerView) {
