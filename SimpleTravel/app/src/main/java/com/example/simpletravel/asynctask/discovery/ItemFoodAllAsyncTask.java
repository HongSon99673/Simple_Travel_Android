...
public class ItemFoodAllAsyncTask extends AsyncTask<Object, Void, ArrayList<Services>> {
    ...
    public ItemFoodAllAsyncTask(Context context, RecyclerView recyclerView) {
