...
public class ItemStayAllAsyncTask extends AsyncTask<Object, Void, ArrayList<Services>> {
    ...
    public ItemStayAllAsyncTask(Context context, RecyclerView recyclerView) {
