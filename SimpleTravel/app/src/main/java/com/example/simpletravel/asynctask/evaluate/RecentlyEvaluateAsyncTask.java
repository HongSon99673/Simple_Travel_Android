...
public class RecentlyEvaluateAsyncTask extends AsyncTask<Object, Void, ArrayList<Services>> {
    ...
    public RecentlyEvaluateAsyncTask(Context context, ListView listView) {
        ...
        if (services != null) {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    IdUsers.services = recentlyRearchAdapter.getItem(i);
